...
|----------|-------------|---------------|
| ENSO and Evaporation | In this analysis, I analyzed only the effect of ENSO in Evaporation, by aggregating statistical analysis, anomalies, composite analysis, etc.| [View Notebook](https://github.com/tasanyphy01773/clim680_project/blob/main/Scripts/680%20F23%20ENSO_Evap-Final.ipynb) |
| IOD and Evaporation | In this analysis, I analyzed only the effect of IOD in Evaporation, by aggregating statistical analysis, anomalies, composite analysis, etc. | [View Notebook](https://github.com/tasanyphy01773/clim680_project/blob/main/Scripts/680%20F23%20IOD_Evap-Final.ipynb) |
| Dual Influence of ENSO and IOD | I showed the dual influence of ENSO and IOD by calculating overlapping time and then showed composite analysis for Positive IOD and El Nino, No Events, Negative IOD and El Nino, Negative IOD and La Nina. As there is not timesteps where Positive IOD and La Lina occurs, it is not shown here. | [View Notebook](https://github.com/tasanyphy01773/clim680_project/blob/main/Scripts/680%20F23%20ENSO_IOD_Dual-Final.ipynb) |
| Effects of ENSO and IOD over Australia | Here, I showed the combined effect of ENSO and IOD over Australia where I performs temporal correlation coefficient, statistical significance etc. | [View Notebook](https://github.com/tasanyphy01773/clim680_project/blob/main/Scripts/680%20F23%20AUS%20Analysis.ipynb) |
...
- CLIM680 Class Notes and Scripts https://prukutu.github.io/CLIM680-Climate-Data/

- Jung, M., Schwalm, C., Migliavacca, M., Walther, S., Camps-Valls, G., Koirala, S., ... & Walker, A. (2020). Scaling carbon fluxes from eddy covariance sites to globe: synthesis and evaluation of the FLUXCOM approach.
